...
<html lang="es">
  <head>
    ...
    <title>Cultores de Colombia</title>
    <!-- CSS files -->
      ...
      <aside class="navbar navbar-vertical navbar-expand-lg" data-bs-theme="dark">
        <div class="container-fluid">
          ...
          <h1 class="navbar-brand navbar-brand-autodark">
            <a href=".">
              <img src="{{ url('static/logo.png') }}" height="48" alt="Logo" style="background-color: #fff; border-radius: 5px;">
              <span style="font-size: 14px">Cultores de Colombia</span>
            </a>
          </h1>
          ...
          <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
              ...
              <li class="nav-item">
                <a class="nav-link" href="{{  url('comunas') }}">
                  <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                  ...
                  <span class="nav-link-title">Comunas</span>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a class="nav-link" href="{{  url('talleres') }}">
                  ...
                  <span class="nav-link-title">Talleres</span>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a class="nav-link" href="{{  url('cultores') }}">
                  <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                    <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-users"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M9 7m-4 0a4 4 0 1 0 8 0a4 4 0 1 0 -8 0" /><path d="M3 21v-2a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4v2" /><path d="M16 3.13a4 4 0 0 1 0 7.75" /><path d="M21 21v-2a4 4 0 0 0 -3 -3.85" /></svg>  
                  </span>
                  <span class="nav-link-title">Cultores</span>
                </a>
              </li>
